...
-- 1) Atualize o primeiro nome de todas as pessoas da tabela sakila.actor 
...
-- e que possuem as classificações "G" , "PG" ou "PG-13" e um custo de substituição maior que $20.
UPDATE film
SET rental_rate = 25
WHERE length > 100
