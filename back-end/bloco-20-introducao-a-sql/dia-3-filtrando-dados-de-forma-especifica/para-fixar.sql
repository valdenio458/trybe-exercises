...
-- Entre no banco de dados sakila
USE sakila;
...
-- que não estão mais ativos no nosso sistema e pertencem à loja com o id = 2 , e não inclua o 
-- cliente KENNETH no resultado. As informações podem ser encontradas na tabela customer
